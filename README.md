...
- Edits and new deals write straight back to the live Google Sheet via a service account.
...
See **[SETUP.md](./SETUP.md)** for the Google service account, ZeptoMail env vars, and Vercel deploy steps.
